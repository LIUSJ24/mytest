package com.bjpowernode.thread.ThreadSafe.exam3;
...
class MyClass {
    // 线程t1启动后，执行m1方法，碰到了synchronized，需要找this对象的锁，所以t1线程会去找mc1对象的锁，找到之后并占有
    ...
    // 线程t2启动后，执行m2方法，碰到了synchronized，需要找this的锁，此时的this对象指的mc2对象的锁，可以找到
